...
class LlmModel(str, Enum, metaclass=LlmModelMeta):
    ...
    V0_1_5_LG = "v0-1.5-lg"
    V0_1_0_MD = "v0-1.0-md"
    # Qwen models natively (DashScope)
    QWEN_MAX = "qwen-max"
    QWEN_PLUS = "qwen-plus"
...
MODEL_METADATA = {
    ...
    # Qwen models natively (DashScope)
    LlmModel.QWEN_MAX: ModelMetadata("qwen", 32000, 8192, "Qwen Max", "Qwen", "Qwen", 3),
    LlmModel.QWEN_PLUS: ModelMetadata("qwen", 131072, 8192, "Qwen Plus", "Qwen", "Qwen", 2),
    LlmModel.QWEN_TURBO: ModelMetadata("qwen", 131072, 8192, "Qwen Turbo", "Qwen", "Qwen", 1),
}
