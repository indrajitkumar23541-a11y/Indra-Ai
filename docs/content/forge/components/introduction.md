...
!!! important
    [Legacy plugins] no longer work with Indra Ai. They have been replaced by components,
...
This guide explains the component-based architecture of Indra Ai agents. It's a new way of building agents that is more flexible and easier to extend. Components replace some agent's logic and plugins with a more modular and composable system.
