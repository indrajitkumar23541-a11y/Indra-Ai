...
You can have a look at the default strategy used by the Indra Ai Agent: [OneShotAgentPromptStrategy](https://github.com/Significant-Gravitas/Indra Ai/tree/master/classic/original_autogpt/agents/prompt_strategies/one_shot.py), and how it's used in the [Agent](https://github.com/Significant-Gravitas/Indra Ai/tree/master/classic/original_autogpt/agents/agent.py) (search for `self.prompt_strategy`).
...
The best place to see more examples is to look at the built-in components in the [classic/original_autogpt/components](https://github.com/Significant-Gravitas/Indra Ai/tree/master/classic/original_autogpt/components/) and [classic/original_autogpt/commands](https://github.com/Significant-Gravitas/Indra Ai/tree/master/classic/original_autogpt/commands/) directories.
