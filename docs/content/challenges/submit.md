...
If you have identified a task or problem that Indra Ai struggles with, you can submit it as a challenge for the community to tackle. Here's how you can submit a new challenge:

## How to Submit a Challenge

1. Create a new `.md` file in the `challenges` directory in the Indra Ai GitHub repository. Make sure to pick the right category. 
